...
export default async function ResearchDiscussionPage({
  params,
}: {
        ...
        <main className={styles.main}>
          <div className={styles.container}>
            <div className={styles.error}>
              <p>{result.error ?? "Research item not found."}</p>
              <p>
                <BackLink fallbackHref="/research">Back</BackLink>
              </p>
            </div>
          </div>
        </main>
  ...
  const sourceName = item.source?.name ?? "Research";
